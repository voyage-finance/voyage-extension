        ...
        <Stack className={styles.root} spacing={0}>
          ...
          <Stack spacing={12}>
            ...
            <Group position="apart" align="center" spacing={0}>
              ...
              <Link
                link={getTxExplorerLink(loan?.metadata?.txHash || '')}
                text={getShortenedAddress(loan?.metadata?.txHash || '')}
              />
            </Group>
            <Group align="center" spacing={0}>
              ...
              <PaymentHoverBoard
                ...
                epoch={loan?.epoch || 0}
              />
              <Text ml="auto" weight="bold" size="lg" style={{ lineHeight: 1 }}>
          ...
          {loan && <RepaymentsWrapped loan={loan} />}
        </Stack>
      )}
    </div>
  );
